...
$router->addRoute(new Route("categories/{name}",[
    "controller"=>"categories",
    "action"=>"category"
]));

$router->addRoute(new Route("login_page",[
    "controller"=>"main",
    "action"=>"login"
]));
$router->addRoute(new Route("categories/{name}/{id}",[
    "controller"=>"categories",
    "action"=>"post"
]));
...
$router->addRoute(new Route("categories/{name}/{id}/likes",[
    "controller"=>"categories",
    "action"=>"like"
]));

$router->addRoute(new Route("admin/{?action}",[
    "controller"=>"admin",
    "action"=>"index"
]));
